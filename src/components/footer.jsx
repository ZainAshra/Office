      ...
      <div className="parent grid bg-blue-950 gap-3 pb-3">
        ...
        <div className="grid grid-cols-2">
          ...
          <div className="flex flex-row justify-center gap-2 mt-2 mr-2">
            ...
            <div>
              <img
                className="cursor-pointer hover:mr-1"
                src={sociallink1}
                alt=""
              />
            </div>
            ...
            <div>
              <img
                className="cursor-pointer hover:ml-1"
                src={sociallink5}
                alt=""
              />
            </div>
        ...
        <div className="md:flex md:flex-row sm:grid sm:grid-cols-2 gap-2 mr-2 ml-2 mt-4">
          <div className="basis-1/5  justify-center md:ml-10 sm:text-center">
          ...
          <div className=" basis-1/5 sm:text-center">
        ...
        <div className="grid grid-cols-2">
          ...
          <div className="flex flex-row justify-center gap-2 mt-2 mr-2">
            <div>
              <span className="text-gray-100"><CopyrightIcon/></span>
            </div>
